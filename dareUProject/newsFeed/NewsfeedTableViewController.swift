...
class NewsfeedTableViewController: UITableViewController
{
    ...
    @IBAction func ShowNewDareVC(_ sender: AnyObject){
        let controller = storyboard?.instantiateViewController(withIdentifier: "daresSB")
...
extension NewsfeedTableViewController
{
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: Storyboard.HeaderCell) as! HeaderCell
